...
const FAQPage: React.FC = () => {
  ...
  const faqs = [
    {
      question: 'Come posso cercare un documento specifico?',
      answer: 'Puoi utilizzare la barra di ricerca nella dashboard, filtrando per parole chiave o selezionando città specifiche dal menu a tendina. I risultati verranno mostrati immediatamente in base ai filtri applicati.'
    },
    {
    ...
    },
    {
      ...
      answer: 'ITFPLUS offre una vasta gamma di documenti giuridici come sentenze, atti legali, moduli, documenti notarili e altri materiali di riferimento categorizzati per area legale e località.'
    },
    {
