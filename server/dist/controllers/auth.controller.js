...
exports.getAdminStats = exports.changePassword = exports.deleteUser = exports.updateUser = exports.createUser = exports.getUserById = exports.getAllUsers = exports.logout = exports.login = exports.register = void 0;
...
const getAllUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let orderBy = { createdAt: 'desc' }; // Default: più recenti prima
        if (sortBy) {
...
const getAdminStats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const [totalUsers, activeUsers, totalDocuments, totalSizeResult] = yield Promise.all([
            ...
            server_1.prisma.document.count(),
            // Calcola la dimensione totale dei documenti
            server_1.prisma.document.aggregate({
                _sum: {
                    fileSize: true
                }
            })
